...
?>
    <body class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <?php include('inc/admin/control.php'); ?>
            </div>
            ...
            <div class="col-md-9 tab-content">
                ...
                <div id="info-teacher" class="tab-pane fade in" role="tabpanel">
                </div>

                <div id="info-student" class="tab-pane fade in " role="tabpanel">
                </div>
