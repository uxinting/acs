<?php
    ...
    @$uNo =$_COOKIE['uNo'];
    //获取当前学生的id
    $sql_student_id='select * from student where sNo="'.$uNo.'"';
...
<ul class="list-group">
    <li class="list-group-item list-group-item-info">
            <div class="btn-group btn-group-sm">
                <div class="btn-group btn-group-sm">
                <button type="button" class="btn btn-default" tabindex="-1" id="flttime_notpub">时间排序</button>
                ...
                <div class="btn-group btn-group-sm">
                <button type="button" class="btn btn-default" tabindex="-1" id="fltcourse_notpub">选择科目</button>
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1">
                    <span class="caret"></span>
                    <span class="sr-only"></span>
                </button>
...
function GetJobs(){
    $.ajax({
        ...
        data: {type: 'jobs_notpub', fltstudentId:window.fltstudentId, flttimeId:window.flttimeId, fltteacherId:window.fltteacherId, fltteacherName:window.fltteacherName, 
