...
<ul class="list-group">
    <li class="list-group-item list-group-item-info">
        <div class="btn-group btn-group-sm">
            ...
            <div class="btn-group btn-group-sm">
                <button type="button" class="btn btn-default" tabindex="-1" id="fltteacher">选择教师</button>
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1">
                    <span class="caret"></span>
                    <span class="sr-only"></span>
                </button>
                <ul class="dropdown-menu">
                <li><a href="javascript: OnChangeTeacherSelect(-1,'');">全部教师</a></li>
                <?php
...
function GetJobs(){
    $.ajax({
        ...
        data: {type: 'jobs_all', flttimeId:window.flttimeId, fltteacherId:window.fltteacherId, fltteacherName:window.fltteacherName, 
