...
<ul class="list-group">
    ...
    <li class="list-group-item">
        ...
        <p><span>2013.12.3</span>~2014.12.30&nbsp;剩余<span class="badge">28</span>天
            <a href="job.php?id=1" class="btn btn-xs btn-default" target="_blank">改待发布</a>
...
function GetJobs(){
    $.ajax({
        ...
        data: {type: 'jobs_pub', flttimeId:window.flttimeId, fltteacherId:window.fltteacherId, fltteacherName:window.fltteacherName, 
