    ...
    <form role="form" class="col-md-7 col-md-offset-0" style="width: 95%">
        ...
        <div class="form-group">
            <label for="jobInSample">输入样例（注：作业不需外部输入时可以为空。仅供参考输入样例。如有多组数据，第一行用N表示测试样例组数）</label>
            <textarea type="text" class="form-control" style="height: 150px;" id="jobInSample" placeholder="输入样例"></textarea>
        </div>
        <div class="form-group">
            <label for="jobInTest">测试用例（注：作业不需外部输入时可以为空。作为学生提交的代码的输入，测试其正确性。如有多组数据，第一行用N表示测试样例组数）</label>
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" class="form-control" id="jobTime_Start" placeholder="开始时间" style="display:inline-block; width:45%;">
            <input type="datetime-local" class="form-control" id="jobTime_End" placeholder="结束时间" style="display:inline-block; width:45%;">
        </div>
        <div class="form-group">
